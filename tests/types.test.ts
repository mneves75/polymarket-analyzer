...
describe("asTokenId", () => {
  ...
  it("rejects non-string input", () => {
    expect(() => asTokenId(123 as unknown as string)).toThrow("expected string, got number");
    expect(() => asTokenId(null as unknown as string)).toThrow("expected string, got object");
    expect(() => asTokenId(undefined as unknown as string)).toThrow("expected string, got undefined");
  });
  ...
  it("rejects ID that is too short", () => {
    expect(() => asTokenId("0x123")).toThrow("invalid length 5, expected 10-66");
  });

  it("rejects ID that is too long", () => {
    const tooLong = "0x" + "a".repeat(100);
    expect(() => asTokenId(tooLong)).toThrow("invalid length 102, expected 10-66");
  });
...
describe("asConditionId", () => {
  ...
  it("rejects non-string input", () => {
    expect(() => asConditionId(123 as unknown as string)).toThrow("expected string, got number");
  });

  it("rejects ID without 0x prefix", () => {
    expect(() => asConditionId("1234567890abcdef")).toThrow("must start with '0x'");
  });

  it("rejects ID that is not exactly 66 characters", () => {
    expect(() => asConditionId("0x1234567890abcdef")).toThrow("invalid length 18, expected 66");
    const tooLong = "0x" + "a".repeat(100);
    expect(() => asConditionId(tooLong)).toThrow("invalid length 102, expected 66");
  });
...
describe("asMarketId", () => {
  ...
  it("rejects non-string input", () => {
    expect(() => asMarketId(123 as unknown as string)).toThrow("expected string, got number");
  });
  ...
  it("rejects invalid slug format", () => {
    expect(() => asMarketId("invalid slug with spaces")).toThrow("invalid slug format");
    expect(() => asMarketId("Invalid-Uppercase-With-Dots.com")).toThrow("invalid slug format");
  });
