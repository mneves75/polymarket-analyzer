...
class Logger {
	...
	/**
	 * Get the component name for this logger instance.
	 * Public accessor to allow ContextLogger to access the parent's component name.
	 */
...
class ContextLogger extends Logger {
	constructor(
		...
		super({ component: parent.component });
	}
